...
# Text resources
my_font = pygame.font.SysFont('Calibri', 25, True, False) #creates usable object named my_font
...
background_music.play(-1) # -1 plays forever
...
while not done:
    ...
    my_text = my_font.render("Score: " + str(score), True, WHITE)  # creates a rendered graphical object my_text
    screen.blit(my_text, [40, 40])  # places rendered image on screen
